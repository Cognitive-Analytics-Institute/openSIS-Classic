                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <?php
                            if ($_REQUEST['reason'])
                                $note[] = 'You must have javascript enabled to use Roots.';
                            ...
                            <form name=loginform method='post' class="text-left" action='index.php'>
                                ...
                                if ($maintain_qr[1]['SYSTEM_MAINTENANCE_SWITCH'] == 'Y') {
                                    ...
                                    <div class="form-group">
                                        <h4 class="text-center text-danger"><i class="icon-warning22" style="font-size: 50px;"></i><br/><br/>Roots is under maintenance and login privileges have been turned off. Please log in when it is available again.</h4>
                                    </div> 
                                    <?php
                                }
