...
function CreateList($dli = '', $pli = '', $sli = '', $cli = '', $mp = '', $mp_name = '')
{
    ...
    $html .= "<tr><td  style=\"font-size:15px; font-weight:bold;\">" . GetSchool(UserSchool()) . "<div style=\"font-size:12px;\">" . _studentSchedulesReport . "</div></td><td align=right style=\"padding-top:10px;\">" . ProperDate(DBDate()) . "<br />" . _poweredBy . " Roots</td></tr><tr><td colspan=2 style=\"border-top:1px solid #333;\">&nbsp;</td></tr></table>";
    ...
    if ($_REQUEST['print'] == 'list') {
        ...
        echo "<tr><td  style=\"font-size:15px; font-weight:bold;\">" . GetSchool(UserSchool()) . "<div style=\"font-size:12px;\">" . _courseCatalog . "</div></td><td align=right style=\"padding-top:5px;\">" . ProperDate(DBDate()) . "<br />" . _poweredBy . " Roots</td></tr><tr><td colspan=2 style=\"border-top:1px solid #333;\">&nbsp;</td></tr></table>";
    }
